...
void main(List<String> arguments) {
  final rawProducts = [
    ...
    RawProductItem(
      ...
      expirationDate: DateTime(2023, 4, 18),
      qty: 2,
    ),
    RawProductItem(
      name: 'Говядина',
      ...
      expirationDate: DateTime(2023, 4, 17),
      qty: 0,
    ),
    RawProductItem(
      name: 'Телятина',
    ...
    RawProductItem(
      ...
      categoryName: 'Мясо',
      subcategoryName: 'Не птица',
      expirationDate: DateTime(2023, 6, 23),
      qty: 5,
    ),
    RawProductItem(
      name: 'Груша',
      categoryName: 'Растительная пища',
      subcategoryName: 'Фрукты',
      expirationDate: DateTime(2023, 6, 25),
      qty: 5,
    ),
  ];
